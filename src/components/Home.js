        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 flex justify-center" data-aos="fade-left">
            <div className="relative w-full flex justify-center">
              <div className="w-96 h-96 sm:w-[50%] sm:h-112 md:w-144 md:h-144 lg:w-160 lg:h-160 xl:w-192 xl:h-192 2xl:w-224 2xl:h-224 rounded-full overflow-hidden border-4 border-slate-700 relative z-10">
                <img
                  src={profile}
                  alt="Developer Profile"
                  className="w-full h-full object-cover"/>
              </div>
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 to-violet-500 rounded-full blur-xl opacity-10 animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
